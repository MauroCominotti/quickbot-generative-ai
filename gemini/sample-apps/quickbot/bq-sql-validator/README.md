# Quickbot - Bigquery Translation Validator (ADK + Agent Engine)

Quickbot Bigquery Translation Validator is a sophisticated application designed to deliver highly personalized travel experiences. Leveraging an [Agent Development Kit (ADK)](https://google.github.io/adk-docs/) and powerful [Agent Engine](https://cloud.google.com/vertex-ai/generative-ai/docs/agent-engine/overview) capabilities. This agents helps to indentify any translation errors between Bigquery and the Source Database(Teradata, Oracle, Snowflake etc). It features a user-friendly frontend and a robust backend API to manage agent interactions and deliver a seamless experience.
